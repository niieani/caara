...
import strategyCrossReview from "../.agents/skills/panel/strategies/cross-review.md" with { type: "text" };
import strategyDebate from "../.agents/skills/panel/strategies/debate.md" with { type: "text" };
import strategyEnsemble from "../.agents/skills/panel/strategies/ensemble.md" with { type: "text" };
