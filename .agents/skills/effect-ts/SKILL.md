...
Patterns from [effect-solutions](https://effect.solutions) and the [Effect source](https://github.com/Effect-TS/effect-smol). This covers the latest v4 APIs.

## Local Source References

- **effect-solutions** (best practices, docs, examples): `./references/effect-solutions/`
- **effect monorepo** (canonical source for all `@effect/*` packages): `./references/effect/`
- Search source for implementations: `grep -r "pattern" ./references/effect/packages/effect/src/`
